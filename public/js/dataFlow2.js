...
//funcion para establecer la coneccion con la base de datos sql server
async function dbConnection() {
  ...
  try {
   ...
   // ETLObject["source"] = result.testQueryResult.source; // le acopla la informacion de la tabla
    ...
    toggleNotificationModal(); // abre la 
...
function setModalHtmlContent(typeOfBlockDraggedId) {
  ...
  if (typeOfBlockDraggedId == "conversion") {
    ...
    function generateSQLQuery(columnName) {
      // Construcción de la consulta SQL para valores nulos en la columna
